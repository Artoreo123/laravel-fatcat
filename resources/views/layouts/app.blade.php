...
{{--        <div class="row" style="height: 61px">--}}
        <div class="row" style="height: 61px">
            <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm fixed-top" style="opacity: 0.9;">
                {{--            <div class="container">--}}
                {{--                <a class="navbar-brand" href="{{ url('book/index') }}"style="text-align: center">--}}
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            ...
                            <form method="GET" action="{{ url('book/index') }}" accept-charset="UTF-8"
...
{{--                                <img src="{{url('/user-demo.png')}}" style="width: 40px;height: 40px;border-radius: 30px">--}}
                                <img src="{{auth()->user()->id}}" style="width: 40px;height: 40px;border-radius: 20px">
        ...
        {{--        <div class="row d-flex justify-content-center" style="min-height: calc(100vh - 61px);">--}}
{{--            <div class="col-2">--}}
                @yield('sidebar')
{{--            </div>--}}
{{--            <div class="col"  style="background-color: snow ;padding-top:30px;margin-top:30px;margin-right: 40px;border-radius: 12px">--}}
{{--                <div class="container">--}}
{{--                <main class="py-4">--}}
                    @yield('content')
{{--                </main>--}}
